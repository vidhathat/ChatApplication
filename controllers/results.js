    ...
    return {
        ...
        postResults: function(req, res){
            async.parallel([
                ...
                res.render('results', {title: 'ChatApplication - Results', user: req.user, chunks: dataChunk});
            })
        },
        ...
        viewMembers: function(req, res){
            async.parallel([
                ...
                res.render('members', {title: 'ChatApplication - Members', user: req.user, chunks: dataChunk});
            })
        },
